...
function loadAdminSettings() {
  var d = { storeName: 'متجري', tagline: 'اختر منتجك المفضل', phone: '', whatsapp: '', email: '', address: '', hours: '', lat: '', lng: '', storeImages: [], wholesaleCode: 'ADMIN123', currency: '₪', accentColor: '#ef4444', lang: 'ar', showFlashSales: true, showStoreCard: true, social: { facebook: '', instagram: '', twitter: '', tiktok: '', youtube: '', telegram: '', snapchat: '', website: '' } };
  try {
